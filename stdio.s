...
write_syscall:
        lea     72(%rsp), %rsi       # get address of character to write
...
#       push    %rsp
        ...
        mov     $10, %rcx    
    	cmp 	$0, %rax
	jns 	print_word_dec_loop
	push    $'-'
	call    putchar
	neg     %rax 
	

# *** Ce code est incorrect (il imprime toujours 0). ***
# *** Vous devez completer son implantation.         ***
